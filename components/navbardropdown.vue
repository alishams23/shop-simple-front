<template>
  <div class="d-flex flex-row" :class="dNone == true ? 'd-none' : ''" v-if="categories != null"
    ...
    <div class="col-2 px-3 border border-bottom-0 m-0 border scrollBarStyleSmall"
      ...
      <div
        ...
        class="px-2 rounded-10 text-center fw-bold py-3" v-for="data in categories" v-bind:key="data"
    ...
    <div class="col-7 scrollBarStyleSmallHidden" style="height: 500px !important; overflow: hidden; overflow: scroll">
      <div class="fw-bold fs-4 p-4 d-flex">
        <div style="width: 2.5px" class="rounded-pill py-2 mx-2 bg-custom-gradient"></div>
      ...
      <div class="w-100 d-flex flex-row flex-wrap" v-for="data in categories" v-bind:key="data">
        <button class="m-3 p-2  rounded-10 btn button-active" v-for="data2 in data.main_category" v-bind:key="data2"
