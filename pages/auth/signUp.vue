          ...
          <div class="page-content">
            ...
            <form class="login-form" @submit.prevent="doRegister">
              <div class="form-group text-right">
                <label for="author" class="py-4">شماره تلفن<span class="f-red">*</span></label>
                <input type="text" id="author" class="form-control rounded-10" maxlength="11" minlength="11"
                  placeholder="مثال : *********0913 " required pattern="[0-9.]+" name="comment[author]"
                  v-model="username" />
                <div class="invalid-feedback"></div>
                <label class="py-4">
                  رمز عبور <span class="f-red">*</span></label>
                <input type="password" id="passwordinput" minlength="8" class="form-control rounded-10" v-model="password"
                  required />
                <div class="invalid-feedback"></div>
                <label class="py-4"> نام <span class="f-red">*</span></label>
                <input v-model="first_name" class="form-control rounded-10" required />

                <label class="py-4">
                  نام خانوادگی <span class="f-red">*</span></label>
                <input v-model="last_name" class="form-control rounded-10" required />
              </div>
              <div class="flex lr">
                <button type="submit" class="btn btn-submit rounded-10 px-5 py-3 bg-custom-gradient">
                  ثبت نام
                </button>
              </div>
            ...
            <router-link to="/auth/signIn/" class="btn-lostpwd spc">از قبل اکانتی دارم</router-link>
          </div>
        </div>
      </div>
    </div>
